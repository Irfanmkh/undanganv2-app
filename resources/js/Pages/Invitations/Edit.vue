...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div
            v-if="$page.props.errors.limit_undangan"
            class="mb-6 p-4 bg-red-50 border border-red-200 text-red-700 rounded-xl flex items-start space-x-3 shadow-sm animate-fade-in"
        >
            <span class="text-xl mt-0.5">⚠️</span>
            <div>
                <p class="font-bold text-sm">Batas Kuota Tercapai!</p>
                <p class="text-xs text-red-600/90 mt-0.5">
                    {{ $page.props.errors.limit_undangan }}
                </p>
            </div>
        </div>
        ...
        <div class="py-2">
            ...
            >
                ...
                <div class="relative flex items-center group">
                    <span
                        class="absolute left-4 text-sm font-semibold text-slate-800 select-none"
                    >
                        loventa.id/
                    </span>
                    ...
                    <TextInput
                        ...
                        :class="
                            form.errors.slug
                                ...
                                : !isPremium
                                  ? 'bg-slate cursor-not-allowed text-slate-800 select-none'
                                  : 'bg-slate text-slate-800 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/30'
                        "
                        v-model="form.slug"
                        :disabled="!isPremium"
